...
//var crawlDocCommentEmotionMaker = (function(docs){
var crawlDocCommentEmotionMaker = (function(docs, ret_num) {
  //var process = function(docs, callback){
  var process = function(docs, ret_num, processCallback) {
    var jsonMaker = require('../lib/50jsonMaker_comment');
              ...
              async.waterfall([
                function(step3_1) {
                  ...
                  async.forEachOfLimit(rets, MAX_SMART_CRUNCHER_SIZE, function(ret, ret_num2, step3_1) {
                    ...
                    ret.emotion_type = "중립"; //logger.debug(resp);
                    retResult.push(ret);
                    step3_1(null);
                  }, function(err) {
                    if (err) {
...
if (exports) {
  module.exports = crawlDocCommentEmotionMaker;
}
